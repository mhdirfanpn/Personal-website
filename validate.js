...
function nameCheck() {
   ...
   if (name == "" || name == null || name === " ") {
      document.getElementById("error-name").innerHTML = "This is a required field";
      return false;
   } else {
...
function emptyCheckSubject() {
   ...
   if (sub == "" || sub == null) {
      document.getElementById("error-sub").innerHTML = "This is a required field";
      return false;
   } else {
...
function emptyCheckMessage() {
   ...
   if (msg == "" || msg == null) {
      document.getElementById("errormessage").innerHTML = "This is a required field";
      return false;
   } else {
...
function emailCheck() {
   ...
   if (mail == "" || mail == null) {
      document.getElementById("error-mail").innerHTML = "This is a required field";
      return false;
   } else {
...
function validateForm() {
   if (!nameCheck() && !emptyCheckSubject() && !emptyCheckMessage() && !emailCheck()) {
      document.getElementById("submitError").innerHTML = "This is a required field";
